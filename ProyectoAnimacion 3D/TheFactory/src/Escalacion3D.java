...
public class Escalacion3D extends JPanel{    
    ...
    double[] puntoA = {250, 700, 10};
    double[] puntoB = {450, 700, 10};
    double[] puntoC = {250, 900, 10};
    double[] puntoD = {450, 900, 10};
    double[] puntoE = {150, 600, 20};
    double[] puntoF = {150, 800, 20};
    double[] puntoG = {350, 600, 20};
    double[] puntoH = {350, 800, 20};
    public double[] puntoP = {-350, -300, -100};
    ...
    public void Cube(Graphics g, Color c){
        ...
        LineaMedia(g, (int)punto6[0], (int)punto6[1], (int)punto8[0], (int)punto8[1], col.CafeRellenoO);
        LineaMedia(g, (int)punto8[0], (int)punto8[1], (int)punto7[0], (int)punto7[1], col.CafeRellenoO);
        ...
        LineaMedia(g, (int)punto8[0], (int)punto8[1], (int)punto4[0], (int)punto4[1], col.CafeRellenoO);
