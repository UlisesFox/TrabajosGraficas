...
public class Relleno3D extends JPanel{    
    ...
    public Relleno3D() {
        double[] puntoA = {-300, -50, 10};
        double[] puntoB = {1540, -50, 10};
        double[] puntoC = {-300, 820, 10};
        double[] puntoD = {1540, 820, 10};
        double[] puntoE = {-320, -20, 20};
        double[] puntoF = {-320, 690, 20};
        double[] puntoG = {1540, -20, 20};
        double[] puntoH = {1540, 690, 20};
        double[] puntoP = {1500, 500, -100};
    ...
    public void fillCube(Graphics g, Color c) {
        ...
        TranguloRelleno(g, (int)punto7[0], (int)punto7[1], (int)punto5[0], (int)punto5[1], (int)punto2[0], (int)punto2[1], col.GrisPared);
        TranguloRelleno(g, (int)punto1[0], (int)punto1[1], (int)punto5[0], (int)punto5[1], (int)punto2[0], (int)punto2[1], col.GrisPared);
        ...
        TranguloRelleno(g, (int)punto3[0], (int)punto3[1], (int)punto6[0], (int)punto6[1], (int)punto4[0], (int)punto4[1], col.GrisPared);
        TranguloRelleno(g, (int)punto8[0], (int)punto8[1], (int)punto6[0], (int)punto6[1], (int)punto4[0], (int)punto4[1], col.GrisPared);
    }
    ...
    public static void main(String[] args) {
        JFrame frame = new JFrame("Relleno 3D");
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        frame.setExtendedState(JFrame.MAXIMIZED_BOTH);
        frame.setUndecorated(true);
        Relleno3D relleno3D = new Relleno3D();
        frame.add(relleno3D);
