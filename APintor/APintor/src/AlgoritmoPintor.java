...
public class AlgoritmoPintor extends JPanel {
    ...
    public AlgoritmoPintor() {
        ...
        rectangulos.add(new Rectangulo(50, 50, 200, 250, Color.RED));
        rectangulos.add(new Rectangulo(100, 100, 250, 200, Color.GREEN));
        rectangulos.add(new Rectangulo(25, 100, 300, 150, Color.BLUE));

        // Se ordenan los rectángulos basados en la posición Y de su punto superior izquierdo
...
class Rectangulo implements Comparable<Rectangulo> {
    ...
    // Constructor que inicializa un rectángulo con sus coordenadas, dimensiones y color
    ...
    // Método de comparación basado en la coordenada Y del primer punto del rectángulo
    @Override
